...
<script src="${staticPath}/js/sys/roleoperation.js"></script>
</head>
<body>
		...
		<div class="row ">
			<div class="col-sm-12">
				<form class="form-inline pull-right" style="padding: 5px">
					<span class="label label-warning">点击行为单选，点击复选框可多选统一授权</span>
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<div class="panel-body">
					已分配的模块
						<ul id="selected" class="ztree" style="height: 300px;width: 200px"></ul>
					</div>
				</div>
			</div>
			<div class="col-sm-8">
